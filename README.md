Please, check out our [new version 1.5](https://github.com/searchivarius/nmslib/tree/pserv), which we will merge into the master branch soon.
-----------------------
...
* Bilegsaikhan, N., Boytsov, L., Nyberg, E. 2015 [Permutation Search Methods are Efficient, Yet Faster Search is Possible](http://boytsov.info/pubs/p2332-naidan-arxiv.pdf) PVLDB, 8(12):1618–1629, 2015 [**[BibTex]**](http://dblp.uni-trier.de/rec/bibtex/journals/corr/NaidanBN15)
