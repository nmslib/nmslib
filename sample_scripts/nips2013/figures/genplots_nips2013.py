...
if __name__ == '__main__':
    ...
    xAxisFields = ['NumCloser',   'NumCloser', 'Recall']
    yAxisFields = ['ImprEfficiency','QueryTime',   'ImprEfficiency']
    #axisTypes   = [AXIS_TYPES.NORMALX_LOGY, AXIS_TYPES.NORMALX_LOGY, AXIS_TYPES.NORMALX_LOGY]
    axisTypes   = [AXIS_TYPES.LOGLOG, AXIS_TYPES.LOGLOG, AXIS_TYPES.LOGLOG]
    #legendPoss  = ['south east', 'north east', 'north east']
    legendPoss  = ['north west', 'north west', 'north west']
