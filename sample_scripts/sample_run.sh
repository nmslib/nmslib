...
$BinDir/release/experiment --distType float --spaceType l2 \
        ...
        --method perm_inv_indx:numPivot=128,numPivotIndex=16,numPivotSearch=4,dbScanFrac=0.01  \
        --method pivot_neighb_invindx:numPivot=32,numPrefix=8,minTimes=8,chunkIndexSize=1024   \
