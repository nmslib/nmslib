...
\subsection{Roadmap}
\todonoteinline{Organization: problem formulation, methods, distances, experimentation}
...
as well as a vanilla uncompressed inverted file. \todonoteinline{Add references to respective sections}

The current version of the manual focuses on the description of distances, search methods,
and on some internal implementation details useful for extending the library.
We also explain how to use our evaluation utility \ttt{experiment}.
