...
public class QueryService {
  ...
  public interface Iface {
    ...
    public List<ReplyEntry> knnQuery(int k, String queryObj, boolean retObj) throws QueryException, org.apache.thrift.TException;

    public List<ReplyEntry> rangeQuery(double r, String queryObj, boolean retObj) throws QueryException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void knnQuery(int k, String queryObj, boolean retObj, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void rangeQuery(double r, String queryObj, boolean retObj, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_knnQuery(int k, String queryObj, boolean retObj) throws org.apache.thrift.TException
    {
    ...
    public void send_rangeQuery(double r, String queryObj, boolean retObj) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void knnQuery(int k, String queryObj, boolean retObj, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      knnQuery_call method_call = new knnQuery_call(k, queryObj, retObj, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class knnQuery_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public knnQuery_call(int k, String queryObj, boolean retObj, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.k = k;
    ...
    public void rangeQuery(double r, String queryObj, boolean retObj, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      rangeQuery_call method_call = new rangeQuery_call(r, queryObj, retObj, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class rangeQuery_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private String queryObj;
      private boolean retObj;
      public rangeQuery_call(double r, String queryObj, boolean retObj, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.r = r;
        this.queryObj = queryObj;
        this.retObj = retObj;
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class knnQuery<I extends Iface> extends org.apache.thrift.ProcessFunction<I, knnQuery_args> {
      ...
      public knnQuery_result getResult(I iface, knnQuery_args args) throws org.apache.thrift.TException {
        knnQuery_result result = new knnQuery_result();
        try {
          result.success = iface.knnQuery(args.k, args.queryObj, args.retObj);
        } catch (QueryException err) {
          result.err = err;
        }
        return result;
    ...
    public static class rangeQuery<I extends Iface> extends org.apache.thrift.ProcessFunction<I, rangeQuery_args> {
      ...
      public rangeQuery_result getResult(I iface, rangeQuery_args args) throws org.apache.thrift.TException {
        rangeQuery_result result = new rangeQuery_result();
        try {
          result.success = iface.rangeQuery(args.r, args.queryObj, args.retObj);
        } catch (QueryException err) {
          result.err = err;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class knnQuery<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, knnQuery_args, List<ReplyEntry>> {
      ...
      public void start(I iface, knnQuery_args args, org.apache.thrift.async.AsyncMethodCallback<List<ReplyEntry>> resultHandler) throws TException {
        iface.knnQuery(args.k, args.queryObj, args.retObj,resultHandler);
      }
    }
    ...
    public static class rangeQuery<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, rangeQuery_args, List<ReplyEntry>> {
      ...
      public void start(I iface, rangeQuery_args args, org.apache.thrift.async.AsyncMethodCallback<List<ReplyEntry>> resultHandler) throws TException {
        iface.rangeQuery(args.r, args.queryObj, args.retObj,resultHandler);
      }
    }
  ...
  public static class knnQuery_args implements org.apache.thrift.TBase<knnQuery_args, knnQuery_args._Fields>, java.io.Serializable, Cloneable, Comparable<knnQuery_args>   {
    ...
    private static final org.apache.thrift.protocol.TField RET_OBJ_FIELD_DESC = new org.apache.thrift.protocol.TField("retObj", org.apache.thrift.protocol.TType.BOOL, (short)3);
    ...
    private static final int __RETOBJ_ISSET_ID = 1;
