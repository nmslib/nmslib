...
The first column is name of the metric used in the data file \ttt{result\_K=1.dat}.
...
The second column is the method display name (it can have expressions that Latex can parse). 
