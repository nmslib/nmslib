...
in the observed performance characteristcs. Thus, some tests
may fail infrequently, if e.g., the actuall recall value is slightly higher or larger
...
This script is supposed to run on Linux only.
