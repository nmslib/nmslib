...
This information is encoded as an array of instances of the class \ttt{MethodTestCase}
...
may fail infrequently, if e.g., the actual recall value is slightly higher or larger
...
Among several objects with identical distances, 
we select the object with the smallest index.
...
and is, therefore, inferior to rank error metrics \cite{Amato_et_al:2003,Cayton2008}.
...
The second entity is either \ttt{norm} or \ttt{log}, 
...
by compilers except the Visual Studio.
