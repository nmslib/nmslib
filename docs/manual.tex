...
This information is encoded as an arrary of instances of the class \ttt{MethodTestCase}
...
to the file
\href{https://github.com/searchivarius/NonMetricSpaceLib/blob/master/similarity_search/test/test_integr.cc#L65}{test\_integr}. 
